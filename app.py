...
#Set up the title and desription of the app
...
# Generative synthetic sales data
def generate_data():
    np.random.seed(42)
    data = {
...
st.subheader(f"T-statistic: {t_statistic}, p-value: {p_value}")
...
# Bar plot for total units sold by the category
plt.figure(figsize=(10, 6))
